...
if (!$_SESSION) {
    ...
    echo "<a style='margin:10px' href='product.php'>Thêm Trị Sản Phẩm</a>";
...
if (isset($_POST["insert"])) {
    ...
    if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "gif" && $imageFileType != "jpeg") {
        echo "File của bạn không phải ảnh hoặc ảnh sản phẩm bị trùng nhau";
    } else {
...
<body>
    <div class="container">
        ...
        <form action="product.php" method="post" enctype="multipart/form-data" style="background-color:#CCCCCC;">
